"""Regression checks for the prism-plat-policy-gate casebook."""
...
from casebook.harness import assert_expected, prism_plat_policy_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(prism_plat_policy_gate_summary(), assert_expected())
